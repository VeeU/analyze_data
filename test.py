...
excel_path = r"V:\NPI\Share\1.LAB OP\9. CNB Test Report\raw\LTP\battery_pack_discharge.xlsx"
json_path = r"V:\NPI\Share\1.LAB OP\9. CNB Test Report\raw\LTP\test_config.json"
    ...
    if user:
        ...
        for index, row in df.iterrows():
            ...
            for match in matches:
                ...
                value = config.get("AEG 8Ah", {}).get(match) or config.get("general", {}).get(match)
